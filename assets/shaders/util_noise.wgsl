...
fn worley_2d(pos: vec2<f32>) -> f32 {
    let grid = floor(pos);
    let coord = fract(pos) - 0.5;
...
// Everything below was copied from https://github.com/johanhelsing/noisy_bevy/blob/main/assets/noisy_bevy.wgsl
